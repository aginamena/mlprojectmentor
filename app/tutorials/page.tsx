...
const tutorials = [
  {
    ...
    sub_tutorials: [
      ...
      },
      {
        ...
        next_tutorial: "what_is_ml5.js_and_how_do_i_use_it",
      },
      {
    ...
    sub_tutorials: [
      {
        ...
        next_tutorial: "what_are_pretrained_models",
      },
      {
        ...
        next_tutorial: "examples_of_pretrained_models",
      },
      {
        ...
        next_tutorial: "playing_with_pretrained_models",
      },
      {
        ...
        next_tutorial: "real_world_use_case_of_pretrained_models",
      },
      {
        ...
        next_tutorial: "first_project_to_build",
      },
      {
